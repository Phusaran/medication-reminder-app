    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <TouchableOpacity onPress={() => navigation.navigate('CaregiverProfile', { caregiver: caregiver })} style={{ marginRight: 15 }}>
                {caregiver.profile_image ? (
                    <Image source={{ uri: caregiver.profile_image }} style={{ width: 40, height: 40, borderRadius: 20, borderWidth: 2, borderColor: '#fff' }} />
                ) : (
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#0056b3', padding: 20, paddingTop: 50, borderBottomLeftRadius: 20, borderBottomRightRadius: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  ...
  fab: { position: 'absolute', bottom: 30, right: 30, width: 65, height: 65, borderRadius: 35, backgroundColor: '#0056b3', justifyContent: 'center', alignItems: 'center', elevation: 8 }
});